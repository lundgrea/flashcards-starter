...
describe('Turn', function() {
  ...
  it('should expect a card object', function() {
    const card = new Card({id: 1, question: 'What allows you to defin  set   of related information using key-value pairs?', answers: ['ob  ', '  array', 'function'], correctAnswer: 'object'});
